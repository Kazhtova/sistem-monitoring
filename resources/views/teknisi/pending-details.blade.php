                ...
                <div class="p-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div class="col-span-1 lg:col-span-5">
                        <div class="bg-slate-50/50 rounded-2xl border border-slate-100 p-7 h-full">
                            <h4 class="text-[12px] font-bold tracking-widest text-slate-500 uppercase mb-6">Waktu Request</h4>
                            ...
                            <div class="relative">
                                ...
                                <div class="space-y-8">
                                    ...
                                    <div class="relative pl-7">
                                        ...
                                        <p class="text-sm font-medium text-slate-500">{{ $mulai->format('d M Y') }}</p>
                                    </div>
                                    ...
                                    <div class="relative pl-7">
                                        ...
                                        <p class="text-sm font-medium text-slate-500">Duration: {{ $stringDurasi }}</p>
                                    </div>
