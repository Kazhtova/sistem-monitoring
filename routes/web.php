...
use App\Http\Controllers\Crud\KomputerController;
use App\Http\Controllers\Crud\LabController;
use App\Http\Controllers\Crud\TeknisiController;
...
Route::get('/', function () {
    return redirect('/monlab');
});

Route::prefix('monlab')->group(function () {
    ...
    Route::middleware(['auth:teknisi', 'restrict:teknisi'])->prefix('teknisi')->name('teknisi.')->group(function () {
        ...
        // CRUD MASTER
        Route::resource('master-teknisi', TeknisiController::class);
        Route::resource('master-lab', LabController::class);
        Route::resource('master-komputer', KomputerController::class);
